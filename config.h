...
#define GAME_TIME  500  //与GAME_RATE相乘，单位毫秒，为游戏最长时间(500)
#define GAME_WIN  220  //胜利标准，深红色与红色方块的总和(50)
...
#define CONNON1_BULLET_NUM 16 //加农炮1弹匣子弹数量
...
#define CONNON3_BULLET_NUM_1 16 //加农炮3左前弹匣子弹数量
#define CONNON3_BULLET_NUM_2 16 //加农炮3正前弹匣子弹数量
#define CONNON3_BULLET_NUM_3 16 //加农炮3右前弹匣子弹数量
...
/************加农炮4配置数据************/
#define CONNON4_PATH ":/pictures/13-cannon-4" //加农炮4图片路径
#define CONNON4_BULLET_NUM 40 //加农炮4弹匣子弹数量
